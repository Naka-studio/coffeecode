...
export const cfcodeDefaultTheme = EditorView.theme(
	{
...
export const cfcodeDefaultHighlightStyle = HighlightStyle.define([
...
export function cfcodeDefault() {
	return [cfcodeDefaultTheme, syntaxHighlighting(cfcodeDefaultHighlightStyle)];
}

export default cfcodeDefault;